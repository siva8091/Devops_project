...
def extract_info(data):
    ...
    email = re.search(r'user/mail/(.+)', data)
...
def write_to_file(project_id, email, project_name, filename='output.txt'):
...
if __name__ == "__main__":
    # Assuming the raw data comes from Jenkins parameter named "ELK_DATA"
