...
# ==========================================
JENKINS_URL = "https://jenkins.verizon.com"
JENKINS_JOB = "Sonar-Cleanup-Archive-Job"
...
def send_post_cleanup_email(
    ...
    try:
        recovered = old_usage - new_usage
        html_body = f"""
        <html>
        <body style="font-family: Arial;">
        <h2 style="color:green;">
        SonarQube Cleanup Completed
        </h2>
        <p>
